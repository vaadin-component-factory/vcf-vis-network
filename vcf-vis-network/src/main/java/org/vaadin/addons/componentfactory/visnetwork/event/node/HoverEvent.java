...
public class HoverEvent extends Event {
    ...
    /** @param properties the node the cursor entered. */
    public HoverEvent(NetworkDiagram source, boolean fromClient, ObjectNode properties) {
        super(source, fromClient);
        getNodeIds().add(properties.get("node").asString());
    }
}
